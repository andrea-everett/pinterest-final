...
function Modal(props) {
   ...
   return ( 
        ...
        <div className='add-pin-container object-center relative container mx-auto  bg-white  h-screen m-20  border-8  sm:h-3/5 sm:w-3/4  rounded-lg' id="">
                        ...
                        <div className='relative' id='right'>
                                        <div className='section1'>
                                                <div className='select_size  bg-gray-100  flex absolute  top-1 right-1'>
                                                        <select defaultValue="Select" value={pinDetails.size} onChange={(e)=> updatePinDetails ({size : e.target.value})} className="pin_size m-0 p-0 relative  overflow-hidden bg-gray-100 w-3/5 h-7 rounded'">
                                                        ...
                                                        <div onClick={()=> save_pin(pinDetails, props.add_pin)} className='"save_pin" bg-red-500 text-center w-16 rounded text-white'>Save</div>
                                                </div>
                                        </div>
                                                ...
                                                <div className='absolute  top-3/4  left-1/2 w-3/4 sm:top-1/2 -translate-x-1/2 -translate-y-1/2 sm:w-full'>
                                                        <label>
                                                                Title
                                                               <br></br> <input placeholder='Add your title'  type="text" className='text-m border-b-10  sm:w-full h-34 pb-7' id="title" value={pinDetails.title} onChange={(e)=> updatePinDetails ({title : e.target.value})}/>
                                                        </label>

                                                        <label>
                                                                Pin Details
                                                                <br></br><input placeholder='Tell everyone what your pin is about' type="text" className='text-m border-b-3 border-gray-400 sm:w-full   pb-7' id="description" value={pinDetails.description} onChange={(e)=> updatePinDetails ({description : e.target.value})}/>
                                                        </label>

                                                        <label>
                                                                  Link
                                                                  <br></br><input placeholder='Add a destination link' type="text" className='text-m border-b-3 w-fit pb-7' id="destination" value={pinDetails.link} onChange={(e)=> updatePinDetails ({link: e.target.value})} />
                                                        </label>
                                                </div>
                                   </div>
                        </div>
